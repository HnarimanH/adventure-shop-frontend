...
function Filters({price, setPrice, setCategory, setSortBy}){
    
    return(
        <div className={`w-[80%] h-full border-l-2 border-b-2 border-t-2  flex flex-col items-center justify-center left-shadow rounded-l-2xl transform duration-300 bg-white`}>

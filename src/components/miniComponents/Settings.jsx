                ...
                <div className="w-full h-full flex flex-col items-center justify-center">
                    ...
                    <div className="w-3/4 h-2/3  border-l-4 border-white flex flex-col items-center justify-center gap-20">
                        ...
                        <div onClick={ForgotPassword}
                         className="cursor-pointer w-40 h-20 text-3xl text-white text-shadow-lg hover:text-4xl hover:text-gray-400 transform duration-300">
                            Change Password
                        </div>
                        
                        <div onClick={() => {setPopup(true)}} className="cursor-pointer w-40 h-10 text-3xl text-red-400  text-shadow-lg hover:text-4xl hover:text-gray-400 transform duration-300">
                            Delete Account
                        </div>
